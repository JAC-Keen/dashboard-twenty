...
window._addEvent = function(collection, event, callback, reason) {
    ...
    window._keenClient.recordEvent(collection, eventData, callback);
    window._events.push({
...
window._keenClient = new KeenTracking({
...
window._products_list = [
    ...
    {
        "id": 4,
        "title": "Platinum Pro and Support",
